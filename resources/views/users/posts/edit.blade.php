        ...
        <div class="mb-3">
            ...
            @foreach ($all_categories as $category)
                ...
                {{-- foreach loops on the all categories
                    ...
                    in_array(1, $selected_categories)
                    in_array(2, $selected_categories)
                    in_array(3, $selected_categories)
                    in_array(4, $selected_categories)
                    in_array(5, $selected_categories)
                    in_array(6, $selected_categories)
