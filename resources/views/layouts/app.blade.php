...
<body>
    <div id="app">
        ...
        <main class="py-5">
            ...
            <!-- 
                When go login or registar we are requesting on HTTP request from our web aplocation

                Example of an HPPP URI/request:
                http://localhost/post/c/show is not an admin
                http://localhost/admin/users is an admin
                http://localhost/admin       is not an admin
